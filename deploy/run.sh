...
processed_dir=${CDR_IE_ROOT}/processed
protos_dir=${CDR_IE_ROOT}/processed
...
python ${CDR_IE_ROOT}/src/processing/labled_tsv_to_tfrecords_single_sentences.py --text_in_files ${CDR_IE_ROOT}/deploy/*processed.txt --out_dir ${CDR_IE_ROOT}/deploy/protos --max_len 2000000 --num_threads 10 --multiple_mentions --tsv_format --min_count 0 --sentence_window 0
