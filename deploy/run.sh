...
python ${CDR_IE_ROOT}/src/processing/ner_to_tfrecords.py --in_files ${processed_dir}/ner_processed_sentence.txt --out_dir ${protos_dir} --load_vocab ${protos_dir} --num_threads 5
